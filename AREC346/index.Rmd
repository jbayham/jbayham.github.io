...
## Import the Data 
Let's begin by importing the data. First, create a directory (folder) for the lab inside of a directory that you can locate and edit.  Rename the new directory `CV_Lab.`  Create a new directory inside of `CV_Lab` called `data`.  
